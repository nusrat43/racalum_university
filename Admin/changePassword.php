                        ...
                        <div id="pay-invoice">
                            <div class="card-body">
                                <div class="card-title">
                                    <h3 class="text-center">Change Password for </h3>
                                </div>
                                <hr>
...
if (isset($_POST['submit'])) {
    ...
    {
        $sql = "update adminlogin set password='$newpassword' , pws='$pswd'";
        $conn->query($sql);
        echo "<script>alert('Password changed successfully!'); window.location='AdminDashboard.php';</script>";
    } else {
