<body>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">Upload Annual Image</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div id="pay-invoice">
                                <div class="card-body">
                                    <div class="card-title">
                                        <h3 class="text-center">Upload Annual Images</h3>
                                    </div>
                                    <hr>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO `annual_pics` (`Photo`, `Caption`) VALUES ('$target_file','$caption')";
        // echo  $sql;

        if($conn->query($sql)) {
            echo "<script> alert('Upload Images Successfully'); window.location='viewAnnualPics.php?' </script>";
        } else {
