                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Upload Glimpse</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Upload Glimpse of Alumni Meet </h3>
                                        </div>
                                        <hr>
...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO `glimpse_pics`(`Photo`, `Caption`, `year`) VALUES ('$target_file','$caption','$year')";
	// echo  $sql;
	
  if ($conn->query($sql)) {
    
    echo "<script>alert('Upload Glimpse Images Successfully');window.location='viewGlimpse.php?'; </script>";
} else {
