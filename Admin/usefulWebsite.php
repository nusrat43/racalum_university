                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Upload Useful Website</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Useful Website</strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Add Useful Website</h3>
                                        </div>
                                        <hr>
                                        <form action="#" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1" >URL</label>
                                                <input id="cc-payment" name="url" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                            </div>
...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO `useful_website`(`url`, `description`) VALUES ('$Url','$Description')";
	// echo  $sql;
	
  if ($conn->query($sql)) {
    
    echo "<script>
           window.location='viewUsefulWebsite.php?'; 
        </script>";
} else {
