                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="#"></a>View Alumni Registered</li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">View Alumni Registered</strong>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <!-- <a href="../editAlumni.php?id=<?php echo $id ?>">Edit</a> -->
                                        ...
                                        <div id="myModal<?php echo $i ?>" class="modal">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header" style="display: flex;">
                                                    <h3 class="modal-title" id="studentModalLabel">Details of Alumni Register</h3>
